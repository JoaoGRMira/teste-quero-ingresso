...
import { mainListItems, secondaryListItems, tertiaryListItems } from '../components/MUI/listItems';
...
export default function Dashboard() {
  ...
  return (
    <ThemeProvider theme={defaultTheme}>
      <Box sx={{ display: 'flex' }}>
        <CssBaseline />
        <AppBar position="absolute" open={open} sx={{ backgroundColor: 'var(--blue)' }}>
          <Toolbar
            sx={{
        ...
        <Drawer variant="permanent" open={open}>
          ...
          <Box
            sx={{
              width: drawerWidth,
              height: '100vh', // Subtrai a altura do AppBar, se houver
              overflowY: 'auto',
              backgroundColor: 'var(--blue)'
            }}
          >
